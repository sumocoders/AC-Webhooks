<?php
  ...
  function webhooks_handle_on_admin_panel(AdminPanel &$admin_panel) {
    $admin_panel->addToTools('webhooks', lang('Webhooks Settings'), Router::assemble('admin_webhooks'), AngieApplication::getImageUrl('admin_panel/webhooks-settings.png', WEBHOOKS_MODULE), array(
